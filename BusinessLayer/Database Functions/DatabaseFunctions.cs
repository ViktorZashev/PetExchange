...
namespace BusinessLayer.Database_Functions
{
    public static class DatabaseFunctions
    {
        ...
        public static void InitialSetup()
        {
            ...
            CountryController.Create(countries);
            Console.WriteLine(TownController.ReadAll().Count);
            ...
            PublicOfferController.Create(publicOffers);
            ...
            var userRequests = new List<UserRequests>
                {
                    ...
                    new UserRequests(Guid.NewGuid(),publicOffers[4], true)
                };
            UserRequestsController.Create(userRequests);
        }
    }
}
